...
public class GenerarReporte {
    ...
    public static void mostrarReporte(String nombreReporte, String titulo, Map parametro){
        InputStream reporte = GenerarReporte.class.getResourceAsStream(nombreReporte); // Reconoce el archivo fisicamente para poder levantarlo
        try{
